...
public class Teste {
    public static void main(String[] args) {
        Fornecedor fornecedor = new Fornecedor("Fornecedor", "Rua A", "123456789", 1000.0, 500.0);
        System.out.println("Saldo do Fornecedor: " + fornecedor.obterSaldo());

        Administrador administrador = new Administrador("Administrador", "Rua B", "987654321", 1, 2000.0, 10.0, 300.0);
        System.out.println("Salário do Administrador: " + administrador.calcularSalario());

        Operario operario = new Operario("Operario", "Rua C", "555555555", 2, 1500.0, 5.0, 1000.0, 5.0);
        System.out.println("Salário do Operario: " + operario.calcularSalario());

        Vendedor vendedor = new Vendedor("Vendedor", "Rua D", "777777777", 3, 1800.0, 8.0, 5000.0, 7.0);
